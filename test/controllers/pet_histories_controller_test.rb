...
class PetHistoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pet_history" do
    assert_difference('PetHistory.count') do
      post pet_histories_url, params: { pet_history: { height: @pet_history.height, pets_id: @pet_history.pets_id, vet_visit_date: @pet_history.vet_visit_date, weight: @pet_history.weight } }
    end
  ...
  test "should update pet_history" do
    patch pet_history_url(@pet_history), params: { pet_history: { height: @pet_history.height, pets_id: @pet_history.pets_id, vet_visit_date: @pet_history.vet_visit_date, weight: @pet_history.weight } }
